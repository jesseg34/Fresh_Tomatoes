...
pulp_fiction = media.Movie(
    ...
    "Avary.",
    "https://upload.wikimedia.org/wikipedia/en/3/3b/Pu"
    "lp_Fiction_%281994%29_poster.jpg",
...
matrix = media.Movie(
    ...
    "https://upload.wikimedia.org/wikipedia/en/c/c1/The_"
    "Matrix_Poster.jpg",
...
gladiator = media.Movie(
    ...
    "https://upload.wikimedia.org/wikipedia/en/8/8d/Gladia"
    "tor_ver1.jpg",
...
fight_club = media.Movie(
    ...
    "https://upload.wikimedia.org/wikipedia/en/f/fc/Fig"
    "ht_Club_poster.jpg",
